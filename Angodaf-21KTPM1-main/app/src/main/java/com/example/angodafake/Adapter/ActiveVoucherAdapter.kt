...
class ActiveVoucherAdapter(private val context: Context, private var voucher: MutableList<Voucher>) : RecyclerView.Adapter<ActiveVoucherAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val voucherItem = LayoutInflater.from(parent.context).inflate(R.layout.custom_active_voucher_adapter, parent, false)
    ...
    fun setOnItemClickListener(listener: ActiveVoucherAdapter.OnItemClickListener) {
